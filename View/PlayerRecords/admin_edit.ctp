	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
										<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PlayerRecord.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PlayerRecord.id'))); ?></li>
	...
	<div id="page-content" class="span9">
		...
		<div class="playerRecords form">
			...
			<?php echo $this->Form->create('PlayerRecord'); ?>
				<fieldset>
					<h2><?php echo __('Edit Player Record'); ?></h2>
				<?php
