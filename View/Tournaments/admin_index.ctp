...
<div id="page-container" class="row-fluid">
	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
				<li><?php echo $this->Html->link(__('New Tournament'), array('action' => 'add'), array('class' => '')); ?></li>						<li><?php echo $this->Html->link(__('List Leagues'), array('controller' => 'leagues', 'action' => 'index'), array('class' => '')); ?></li> 
	...
	<tr>
		...
		<td><?php echo h($tournament['Tournament']['start_year']); ?>&nbsp;</td>
		<td><?php echo h($tournament['Tournament']['active']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $tournament['Tournament']['id']), array('class' => 'btn btn-mini')); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $tournament['Tournament']['id']), array('class' => 'btn btn-mini')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tournament['Tournament']['id']), array('class' => 'btn btn-mini'), __('Are you sure you want to delete # %s?', $tournament['Tournament']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
			</table>
