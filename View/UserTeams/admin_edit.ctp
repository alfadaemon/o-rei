	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
										<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserTeam.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserTeam.id'))); ?></li>
	...
	<div id="page-content" class="span9">
		...
		<div class="userTeams form">
			...
			<?php echo $this->Form->create('UserTeam'); ?>
				<fieldset>
					<h2><?php echo __('Edit User Team'); ?></h2>
				<?php
