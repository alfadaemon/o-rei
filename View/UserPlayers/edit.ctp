	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
										<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserPlayer.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserPlayer.id'))); ?></li>
	...
	<div id="page-content" class="span9">
		...
		<div class="userPlayers form">
			...
			<?php echo $this->Form->create('UserPlayer'); ?>
				<fieldset>
					<h2><?php echo __('Edit User Player'); ?></h2>
				<?php
