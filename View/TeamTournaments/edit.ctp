	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
										<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TeamTournament.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TeamTournament.id'))); ?></li>
	...
	<div id="page-content" class="span9">
		...
		<div class="teamTournaments form">
			...
			<?php echo $this->Form->create('TeamTournament'); ?>
				<fieldset>
					<h2><?php echo __('Edit Team Tournament'); ?></h2>
				<?php
